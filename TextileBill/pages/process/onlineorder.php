...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Point Of Sale
            <small>List of POS(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Sales</a></li>
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Point Of Sale Mgmt</a></li>            
        </ol>
    </section>
    <!-- Main content -->
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
	"ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=onlineorder"
    });
</script>