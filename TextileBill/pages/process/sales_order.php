...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Sales</a></li>            
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>pages/process/addsales_order.php">Add New</a></h3>
                &nbsp;&nbsp;&nbsp;
                  <h3 class="box-title"><a href="<?php echo $sitename; ?>pages/process/salesorder-sales.php">Convert Sales Order to Sales</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
...
<?php if($_SESSION['usertype']!='subuser') { ?>                                    
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>process/' + a + '/editsales_order.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
    "ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=salesorder"
    });
</script>