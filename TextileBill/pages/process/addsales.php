...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>pages/process/onlineorder.php"><i class="fa fa-circle-o"></i> Sales</a></li>
            <!-- <li class="active"><?php
                if ($_REQUEST['lid'] != '') {
                    echo 'Edit';
                } else {
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                       ...
                       <input type="hidden" id="txt_name">
                        <input type="hidden" id="txt_name1">
...
<?php } ?>							
						...
						<button type="button" alt="Add Customer" title="Add Customer" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" style="height:36px;"><i class="fa fa-plus" aria-hidden="true" alt="Add Customer" title="Add Customer"></i></button>
						<?php } ?>
						</td>
						</tr>
						</table>
						...
						<div class="col-md-1" style="margin-left:78px; width: 13%;">

                            <label>Order Method</label>   
<select name="order_method" class="form-control" style="margin-top: 12px;width:fit-content;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
...
<?php } ?>                          
 ...
 <label>Order Type <span style="color:#FF0000;">*</span></label>                                  
						...
						<select name="billtypemast" id="billtype" class="form-control" required="required"  style="margin-top: 12px;width:fit-content;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
                        <option value="1" <?php
...
<select name="gsttype" id="gsttype" class="form-control" style="margin-top: 12px;width:fit-content;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
                        <option value="1" <?php
    ...
    <table width="100%">
                    ...
                    <?php //} ?>
                        ...
                        <tr>
                        <td colspan="2"><input type="text" class="form-control"  <?php if(getsales('billtype',$_REQUEST['lid'])!='1') { ?> readonly="" <?php } ?> name="bill_no" id="bill_no" style="width:80px;" required="required"  value="<?php if($_REQUEST['lid']!=''){ echo getsales('bill_number',$_REQUEST['lid']); } else { 
                            $customerid1 = FETCH_all("SELECT  * FROM `online_order` WHERE `id`!=? AND date(`cudate`)='".date('Y-m-d')."' ORDER BY `id` DESC", 0);
                        ...
                        <div class="col-md-3"  style="margin-left:5px;">
                            ...
                            <table width="100%" border="1">
                                <tr>
                                    <td> <input type="radio" name="taxtype" value="1" <?php if(getsales("taxtype", $_REQUEST['lid'])==1) { ?> checked="checked" <?php } ?>>&nbsp;&nbsp;Include Tax  </td>
                                     <td> <input type="radio" name="taxtype" value="2" <?php if(getsales("taxtype", $_REQUEST['lid'])==2) { ?> checked="checked" <?php } ?>>&nbsp;&nbsp;Exclude Tax  </td>
                                 </tr>   
                             </table>
                        </div>
												...
												<?php if($_REQUEST['type']!='view') { ?>  
                                                    ...
                                                    <td><?php echo $b; ?></td>
                                                      <td><button type="button" id="srchproduct" alt="Add Customer" class="btn btn-info btn-sm" style="height:36px;" id="ui-id-1" title="Search & Find">Search & Find&nbsp;&nbsp;<i class="fa fa-search" aria-hidden="true" alt="Search Product" title="Search Product
                                                                "></i></button></td>
                                                    <td>
                                                          <input type="hidden" name="gstresult[]" id="gstresult" class="form-control gstresult">
...
<td>
    <input type="hidden" style="text-align: right;" readonly="readonly" name="mrp_price[]" id="mrp_price" class="form-control mrp_price" value="" />
...
<input type="hidden" name="gstvalue" id="gstvalue" class="form-control" value="<?php echo getsales("gstvalue", $_REQUEST['lid']); ?>">
        <input class="form-control"  type="text" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> name="cgstvalue" id="cgstvalue" value="<?php echo stripslashes(getsales("cgstvalue", $_REQUEST['lid'])); ?>"></div>
</div>
   </td>
   ...
   <tr>
    <td colspan="2">
        <div class="row" <?php if(getsales("gsttype", $_REQUEST['lid'])=='2') { ?> style="display:none;" <?php } else { ?> style="display:block;" <?php } ?> id="gstdisp1">
    <div class="col-md-6" style="padding-right: 0px;">SGST Value:</div>
       <div class="col-md-6"  style="padding-left: 20px;"><input class="form-control"  type="text" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> name="sgstvalue" id="sgstvalue" value="<?php echo stripslashes(getsales("sgstvalue", $_REQUEST['lid'])); ?>"></div>
</div>
   </td>
...
$.ajax({
  ...
  $this.parent().parent().find('.rate').val(rateval);
   ...
   // $this.parent().parent().find('#meter').attr('readonly', false);
   //  $this.parent().parent().find('#style').attr('readonly', true);
  if(myArray[5]!='') {
     //$this.parent().parent().find('#style').attr('readonly', false);
   $this.parent().parent().find('#style').html(myArray[5]);
  // $this.parent().parent().find('#meter').attr('readonly', true);
}
...
var userid =  $('#txt_name1').val(); // selected value
