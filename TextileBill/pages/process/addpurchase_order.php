...
$msg = addpurchaseorder($style1,$meter1,$orgrate1,$mrp_price1,$hsn1,$oid1,$bill_no,$supplierid, $date, $netweight, $amount, $status,$object1, $quantity1,$rate1,$tamount1, $sub_total,$discount,$tot_amt,$payment_type,$advance_amount,$balance_amount,$getid);
}
...
<input type="hidden" style="text-align: right;" name="mrp_price[]" readonly="readonly" id="mrp_price" class="form-control mrp_price" value="<?php echo $object1list['mrp_price']; ?>" /><input type="hidden" style="text-align: right;" name="orgrate[]" readonly="readonly"  id="orgrate[]" class="form-control orgrate" value="<?php echo $object1list['orgrate']; ?>"/>
            ...
            <input type="text" style="text-align: right;" name="rate[]" id="rate[]" class="form-control rate" readonly="readonly" value="<?php echo $object1list['rate']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="ratehidden" id="ratehidden" value="" /></td>
...
<input type="hidden" style="text-align: right;" name="orgrate[]" readonly="readonly"  id="orgrate[]" class="form-control orgrate"/>
    ...
    <input type="number" style="text-align: right;" readonly="readonly" name="rate[]" id="rate[]" class="form-control rate" value="" /><input type="hidden" name="ratehidden" id="ratehidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
...
<!-- /.box-body -->
                <div class="box-footer">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <?php if ($_REQUEST['lid'] != '') { ?>
<a href="<?php echo $sitename; ?>pages/process/purchasebarcode.php?purchaseid=<?php echo $_REQUEST['lid']; ?>" style="font-size:19px;" target="_blank"><button type="button" class="btn btn-success" style="float:right;">Print Barcode</button></a>
 <?php } ?>
</div>
                        <div class="col-md-3">
