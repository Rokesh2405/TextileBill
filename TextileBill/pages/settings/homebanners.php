...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-picture-o"></i> Home Banners</a></li>
        </ol>
    </section>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left" width="31%" >Title1</th>                                  
                                    <th style="text-align: left" width="27%" >Title2</th>
                            ...
                            <?php
                            $ndepart = $db->prepare("SELECT * FROM `homebanners`");
                            $ndepart->execute();
                            if ($ndepart > 0) {
                                ?>
                                <tbody>
                                    ...
                                    while ($fdepart = $ndepart->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" ><i class="fa fa-edit" onclick="javascript:editthis('<?php echo $fdepart['hbid']; ?>');" style="cursor:pointer;"></i></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
