...
if (isset($_REQUEST['submit'])) {
   ...
   $msg = addbeat($beatname,$area,$customer,$status,$getid);
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/beat.htm"><i class="fa fa-circle-o"></i> Beat</a></li>
            <li class="active"><?php
                if ($_REQUEST['id'] != '') {
                    echo 'Edit';
                } else {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Beat Name <span style="color:#FF0000;">*</span></label>
							 <input type="text"  required="required" name="beatname" id="beat_name" placeholder="Enter Beat Name" autocomplete="off" class="form-control" value="<?php echo getbeat('beatname',$_REQUEST['id']); ?>" />
                        </div>
                        <div class="col-md-6">
                            <label>Area <span style="color:#FF0000;">*</span></label>
                            <select name="area" class="form-control" required onchange="show_contacts(this.value);">
...
{
?>
 <option value="<?php echo $customerfetch['city']; ?>" <?php if(getbeat("area", $_REQUEST['id'])==$customerfetch['city']) { ?> selected="selected" <?php } ?>><?php echo $customerfetch['city']; ?></option>
<?php } ?>                      
                            </select>
                    ...
                    <div class="row">
                         <div class="col-md-12">
                          ...
                          <div class="row">
    <div class="col-md-12" id="getcustomer">
        <?php
          if(getbeat('customer', $_REQUEST['id'])!='') {
        $area=getbeat("area", $_REQUEST['id']);
...
<?php
 $cuslist=explode(',',getbeat('customer', $_REQUEST['id']));
while($rowbeats = $beats->fetch(PDO::FETCH_ASSOC)){
    ?>
<div class="col-md-3">
<input type="checkbox" name="customer[]" value="<?php echo $rowbeats['id']; ?>" <?php if(in_array($rowbeats['id'],$cuslist)) { ?> checked="checked" <?php } ?>/>&nbsp;&nbsp; <?php echo $rowbeats['name']; ?>  
...
<?php } ?>
                    ...
                    <div class="row">
                         ...
                         <option value="1" <?php if(getbeat('status', $_REQUEST['id'])=='1') { ?> selected="selected"<?php } ?>>Active</option>      
                         <option value="0" <?php if(getbeat('status', $_REQUEST['id'])=='0') { ?> selected="selected"<?php } ?>>Inactive</option>      
                          </select>
                      </div>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>master/beat.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
