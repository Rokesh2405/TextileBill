...
global $db;
$sql = $db->prepare("UPDATE `settings` SET `setting_name`='Salesprint',`setting_value`='" . $_REQUEST['sales_print'] . "' WHERE `id`=?");
$sql->execute(array('1'));
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label>Sales Print Option<span style="color:#FF0000;">*</span></label>
                        </div>
                         <div class="col-md-4">
							 <input type="radio" name="sales_print" value="1" <?php if(getsettings('setting_value',1)=='1') { ?> checked="checked" <?php } ?>>&nbsp;&nbsp;3 Inch
                             &nbsp;&nbsp;
                             <input type="radio" name="sales_print" value="2" <?php if(getsettings('setting_value',1)=='2') { ?> checked="checked" <?php } ?>>
                             &nbsp;&nbsp;A4 
                        </div>
