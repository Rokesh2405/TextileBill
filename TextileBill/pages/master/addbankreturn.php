...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/addbankreturn.htm"><i class="fa fa-circle-o"></i>Bank Return </a></li>
            <li class="active"><?php
//                if ($_REQUEST['rid'] != '') {
//                    echo 'Edit';
//                } else {
...
<script type="text/javascript">
   $("#month").change(function(){
    // alert('Eaaj');
          ...
          //alert(page);
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/banksearchajax.php",
...
//            alert('hiii');
            ...
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateamountbank.php",
...
//                $("#customerid").val(a);
        ...
        $("#totalprincipal").click(function () {
            ...
            var year = $('#yearcalc').val();
             var status = $('#status').val();
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateprincipalbank.php",
                data: {month: month, year: year, status: status},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
        ...
        $("#totalinterest").click(function () {
            ...
            var year = $('#yearcalc').val();
             var status = $('#status').val();
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateinterestbank.php",
                data: {month: month, year: year, status: status},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
