...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/addpawnview.htm"><i class="fa fa-circle-o"></i> Pawn View</a></li>
            <li class="active"><?php
//                if ($_REQUEST['rid'] != '') {
//                    echo 'Edit';
//                } else {
...
//$purid = get_bill_settings('prefix', '2') . str_pad(get_bill_settings('current_value', '2'), get_bill_settings('format', '1'), '0', STR_PAD_LEFT);
                            ...
                            $res1 = $db->prepare("SELECT * FROM `loan` WHERE `status`=?");
                            $res1->execute(array('0'));
                            $sum_calamount = 0;
                            while($row1 = $res1->fetch(PDO::FETCH_ASSOC)) {
                            $sum_calamount += $row1['amount'];
                            }
                            ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" readonly="" class="form-control" name="" value='<?php echo $sum_calamount; ?>'>
                        </div>
                        <div class="col-md-3">
...
//            alert(a);
            $.ajax({
                ...
                url: "<?php echo $sitename; ?>pages/master/searchajaxpawn.php",
...
//            alert('hiii');
            ...
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateamountpawn.php",
...
//                $("#customerid").val(a);
        ...
        $("#totalprincipal").click(function () {
            ...
            var year = $('#yearcalc').val();
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateprincipalpawn.php",
                data: {month: month, year: year},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
        ...
        $("#totalinterest").click(function () {
            ...
            var year = $('#yearcalc').val();
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateinterestpawn.php",
                data: {month: month, year: year},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
