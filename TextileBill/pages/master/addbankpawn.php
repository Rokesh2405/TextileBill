...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/addbankpawn.htm"><i class="fa fa-circle-o"></i>Bank Pawn </a></li>
            <li class="active"><?php
//                if ($_REQUEST['rid'] != '') {
//                    echo 'Edit';
//                } else {
...
//                                        }
                    ...
                    <div class="row">
                         <?php
                            ...
                            $res1 = $db->prepare("SELECT * FROM `loan` WHERE `status`=? AND `returnstatus`=? OR `returnstatus`=?");
                            $res1->execute(array('1', '1', '2'));
                            $sum_amount = 0;
                            while($row1 = $res1->fetch(PDO::FETCH_ASSOC)) {
                            $sum_amount += $row1['amount'];
                            }
                            // echo "<script>alert(".$sum_miles.");</script>";
                            ?>  
                        <div class="col-md-3">
                            <label>No of Pawn<span style="color:#FF0000;">- </span> <?php echo $pcount; ?></label>
                        ...
                        <div class="col-md-3">
                            ...
                            $res1 = $db->prepare("SELECT * FROM `return` WHERE `status`=? ");
                            $res1->execute(array('0'));
                            $sum_reamount = 0;
                            while($row1 = $res1->fetch(PDO::FETCH_ASSOC)) {
                            $sum_reamount += $row1['amount'];
                            }
                            ?> 
                            <label>No of Return <span style="color:#FF0000;">-</span> <?php echo $rcount; ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            $sum_totamount = 0;
                            while($row1 = $res1->fetch(PDO::FETCH_ASSOC)) {
                            $sum_totamount += $row1['amount'];
                            }
                            ?> 
                            <label>Total Bill Performed <span style="color:#FF0000;">-</span> <?php echo $tcount; ?></label>
                            
                        </div> 
                    </div> 
                     <div class="row">
                        <div class="col-md-3">
                            <input type="text" readonly="" class="form-control" name="" value='<?php echo $sum_amount; ?>'>
                        </div>
                        <div class="col-md-3">
                            <input type="text" readonly="" class="form-control" name="" value='<?php echo $sum_reamount; ?>'>
                        </div> 
                        <div class="col-md-3">
                            <input type="text" readonly="" class="form-control" name="" value='<?php echo $sum_totamount; ?>'>
                        </div>
                    </div>
                    <br>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form name="department" id="department"  method="post" enctype="multipart/form-data">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" required="required" name="year" id="year" placeholder="Enter Year" class="form-control" value="" maxlength="10"/>
                                </div>
                        ...
                        <form name="department" id="department"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Status <span style="color:#FF0000;">*</span></label>
                                    <input type="text" class="form-control" name="status" id="status" value="Pawned" readonly="readonly" />   
                                </div>
<!--                                <div class="col-md-3" id="calculation">
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $('#find').click(function () {
            var re = $('#receiptno').val();
//            document.getElementById('modalvalue').value = re;
            $.ajax({
                type: "POST",
                catch : "false",
...
//            alert('hiii');
            ...
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateamountbankpawn.php",
...
//                $("#customerid").val(a);
        ...
        $("#totalprincipal").click(function () {
            ...
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateprincipalbankpawn.php",
                data: {month: month, year: year},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
        ...
        $("#totalinterest").click(function () {
            ...
            $.ajax({
                url: "<?php echo $sitename; ?>pages/master/calculateinterestbankpawn.php",
                data: {month: month, year: year},
                success: function (data) {
                    $("#calculation").html(data);
//                $("#customerid").val(a);
...
//            alert(a);
            $.ajax({
                ...
                url: "<?php echo $sitename; ?>pages/master/banksearchajaxpawn.php",
...
//        $("#totalamount").click(function () {
//            $.ajax({
//                url: "<?php echo $sitename; ?>pages/master/bankcalculateamount.php",
//                success: function (data) {
//                    $("#calculation").html(data);
////                $("#customerid").val(a);
//
