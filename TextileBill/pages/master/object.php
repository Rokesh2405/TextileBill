...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(3),  tbody tr td:nth-child(6),tbody tr td:nth-child(7),tbody tr td:nth-child(8),tbody tr td:nth-child(9) {
        text-align:left;
        font-size: 19px;
    }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           Sales Product
            <small>List of Sales Product(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Sales</a></li>
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Sales Product Mgmt</a></li>            
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addobject.htm">Add New Sales Product</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
