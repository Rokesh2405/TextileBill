...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Tax(s)"))
            {
                return true;
            }
            else
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
                ...
                <h3 class="box-title"><a href="<?php echo $sitename; ?>accounts/addtax.htm">Add New Tax</a></h3>
            </div> 
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>accounts/' + a + '/edittax.htm';
    }
</script>
<?php
