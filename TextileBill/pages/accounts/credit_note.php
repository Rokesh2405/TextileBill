...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    ...
    foreach($_REQUEST['chk'] as $ck){
        transaction_del($ck,'Credit_Note');
    }    
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>accounts/addcredit_note.htm">Add Credit Note</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
<?php echo $msgs; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>accounts/' + a + '/editcredit_note.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.htm?types=account_credit"
    });
</script>
