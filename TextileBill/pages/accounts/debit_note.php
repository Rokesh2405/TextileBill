...
<style type="text/css">
    #normalexamples tbody tr td:nth-child(1),tbody tr td:nth-child(6),tbody tr td:nth-child(7) {
        text-align:center;
    }
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>accounts/adddebit_note.htm">Add Debit Note</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
<?php echo $msgs; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>accounts/' + a + '/editdebit_note.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.htm?types=account_debit"
    });
</script>
