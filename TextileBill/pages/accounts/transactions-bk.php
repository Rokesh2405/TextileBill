    ...
    <?php } ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="ledger" id="ledger" class="form-control ledger_select2">
                                    <option value="">Show all</option>
                    <?php
                        $supp = $db->prepare("SELECT * FROM `ledger` WHERE `status`='1' ORDER BY `Name`");
                        $supp->execute();
                    ...
                    while ($fsupp = $supp->fetch()) {
                        ...
                        ?>><?php echo $fsupp['Name']; ?></option>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control usedatepicker" name="tdate" id="tdate" value="<?php if ($_REQUEST['tdate']) {
                                    echo $_REQUEST['tdate'];
                                } else {
                                    echo date("d-M-Y");
                                } ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2"  style="display: none;">
                                <a  class="btn btn-info" href="#" onclick="printDiv()"  ><i class="fa fa-download "></i>&nbsp;&nbsp;Print</a>
                            </div>
                 ...
                 //   $sel = $paging->sql;
                   ...
                   // echo $sel->rowCount();
                    ?>
                        ...
                        <div id="printdivs">   <div class="table-responsive" style="text-align: center" >
...
<?php if ($_REQUEST['ledger'] == '') { ?>
    ...
    ?>
                                        ...
                                        ?></td>
                                            <td style="text-align: center;"><span style="color: #000000;cursor: pointer;" onclick='show_details(<?php echo $fdepart['id']; ?>);'  data-toggle="modal" data-target="#myModal"><i class="fa fa-eye" aria-hidden="true"></i></span></td>
                                        </tr>
                                                <?php
                                                $i++;
                                                if ($id == 1) {
