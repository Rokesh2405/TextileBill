                    ...
                    <div class="table-responsive">
                       ...
                       <center> SALES RETURN</center>
                        <table id="normalexamples" class="table table-bordered table-striped">
                            ...
                            <?php
                        $sql4 = $db->prepare("SELECT * FROM `salesreturn`");
                            $sql4->execute();
                            $result4 = $sql4->rowcount();
                            if ($result4 > 0) {      
                                while ($purchase = $sql4->fetch(PDO::FETCH_ASSOC)) {

                                    $sid=$purchase['Customer_name'];                             
                                    $ssobj=$purchase['silver_object'];
                                    $ssdate=$purchase['sales_date'];            
                                    ...
                                    $sreson=$purchase['reson_return'];            
                                        ?>
                                         ...
                                         <tr>
                                                    <td>
                                                        <?php
                                       $res2 = pFETCH("SELECT * FROM `sales` WHERE `id`=?",$sid);
                                while($row2 = $res2->fetch(PDO::FETCH_ASSOC)) {
                                                     echo $row2['supplierid'];       
                                    }
