...
//    $jid_w = implode(',',$jid_w);
    ...
    $msg = addinvoice($status, $finalnettotal, $task_extraamt, $invoicefrom, $invoice_jobid, $additionchargprc, $task_empamt2, $task_tax, $amt, $passupvalue, $task_passup12, $passup_amount2, $task_totamount, $task_description, $task_qty, $task_unitprice, $task_unitprice1, $additioncharg, $pay_id,$task_employee2, $task_description2, $task_qty2, $task_unitprice2, $jobid, $customer, $price_category, $pickup_date, $pickup_time, $pickup_location, $pickup_lat, $pickup_lng, $drop_location, $drop_lat, $drop_lng, $km, $description, $subtotal, $nettotal, $tax, $additionalcharge, $empqty1, $Emptotal, $draft,$jid_t,$jid_a,$jid_w,$ip, $getid);
}
...
if (isset($_REQUEST['delid']) && $_REQUEST['delid'] != '') {
    ...
    $up1 = $db->prepare("UPDATE `jobs_new` SET `nettotal`=? WHERE `id`=?");
                                        ...
                                        <table width="100%" class="table table-bordered" id="task_table" cellpadding="0"  cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                while ($fetc = $deta->fetch()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="task_totamount[]" class="form-control" onkeyup="calculate_subprice($(this));" value="<?php echo $fetc['total_rate']; ?>"  /></td>
                                                ...
                                                <tr id="firsttasktr" style="display:none;">
                                                    ...
                                                    <td><input type="number" step="0.0001" name="task_totamount[]" class="form-control" onkeyup="calculate_subprice($(this));" /></td>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="7" style="border:0;padding-top: 15px;"><strong>Total Qty : <span class="empqty1"><?php echo $showrecords['empqty1']; ?></span><br></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table width="100%" class="table table-bordered" cellpadding="0"  id="worker_table" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $deta = $db->prepare("SELECT * FROM `job_newinvoice` WHERE `subject`='Worker Charge' AND `job_id`='" . $showrecords['id'] . "' ");
                                            $deta->execute();
                                            $sno = 0;
                                            while ($fetc = $deta->fetch()) {
                                                $sno++;
                                 ...
                                 <?php /*                       <span class="input-group-addon" id="employees_grid_search" style="cursor: pointer;width: 30%;float:left;height: 34px;" data-toggle="modal" data-target="#employee_grid_modal" onclick="setmodal_tr($(this).parent().parent())"><i class="fa fa-search"></i></span> */ ?>
                                                    ...
                                                    <td id="basicpay"><input type="number" step="0.001" name="empbasicpay[]" id="empbasicpay[]" class="form-control" onkeyup="calculate_workerprice($(this));" value="<?php echo $fetc['task_unit_price']; ?>" /></td>                                                    
                                                    <td id="empqty"><input type="number" step="0.001" name="empqty[]" id="empqty[]" class="form-control" onkeyup="calculate_workerprice($(this));" value="<?php echo $fetc['task_quty']; ?>" /></td>
                                                    <td><input type="number" step="0.001" name="empextraamt[]" id="empextraamt[]" class="form-control" onkeyup="calculate_workerprice($(this));" value="<?php echo $fetc['task_extra_amt']; ?>" /></td>
                                                    <td><input type="number" step="0.001" name="empamt[]" id="empamt[]" class="form-control" onkeyup="calcuempamt();" value="<?php echo $fetc['task_amount_aud']; ?>" /></td>
...
<?php } ?>
                                      ...
                                      <?php /*              <span class="input-group-addon" id="employees_grid_search" style="cursor: pointer;width: 30%;float:left;height: 34px;" data-toggle="modal" data-target="#employee_grid_modal" onclick="setmodal_tr($(this).parent().parent())"><i class="fa fa-search"></i></span> */ ?>
                                                ...
                                                <td id="basicpay"><input type="number" step="0.001" name="empbasicpay[]" id="empbasicpay[]" onkeyup="calculate_workerprice($(this));" class="form-control"></td>                                                    
                                                <td id="empqty"><input type="number" step="0.001" name="empqty[]" id="empqty[]" class="form-control" onkeyup="calculate_workerprice($(this));"></td>
                                                <td><input type="number" step="0.001" name="empextraamt[]" id="empextraamt[]" class="form-control" onkeyup="calculate_workerprice($(this));" value="<?php echo $fetc['task_extra_amount']; ?>" /></td>
                                                <td><input type="number" step="0.001" name="empamt[]" id="empamt[]" class="form-control" onkeyup="calcuempamt();">
                                            </tr> 
                                        </tbody>
...
// $('input[name="subtotal"]').val(subtotal.toFixed(2));
    ...
    function calculate_workerprice(elem) {
        ...
        new_elem.find('input[name="empamt[]"]').val(emptot);
        $('input[name="empamt[]"]').each(function (e) {
            if ($(this).parent().parent().attr('id') != 'firsttasktr') {
                emptot = parseFloat(emptot) + (parseFloat($(this).val()) || parseFloat(0));
            }
...
// $('input[name="subtotal"]').val(subtotal.toFixed(2));
    ...
    function delrec_wor(elem, id) {
        if (confirm("Are you sure want to delete this worker?")) {
            $(elem).parent().remove();
            calculate_total($('select[name="task_tax"]').val());
            window.location.href = "<?php echo $sitename; ?>invoice/<?php echo $showrecords['id'] ?>/editnewinvoice.htm?delid1=" + id + "&tot=" + $('input[name="nettotal"]').val();
        }
    }
    initMap();
