 ...
 * @method \Aws\Result deleteCollection(array $argsRekognitionClient = [])
...
class CreateCollection extends AwsClient {}

class IndexFaces extends AwsClient {}

class CompareFaces extends AwsClient {}
